  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-primary-foreground shadow-elevated hover:shadow-glow hover:scale-[1.02] transition-all duration-300",
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-soft hover:shadow-card",
        glass: "glass hover:bg-card/90 text-foreground shadow-soft",
        pill: "rounded-full bg-muted text-muted-foreground hover:bg-muted/80 hover:text-foreground",
        pillActive: "rounded-full bg-primary text-primary-foreground shadow-soft",
      },
      size: {
